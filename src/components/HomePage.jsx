                    ...
                    >
                        ...
                        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center">
                            <div className="text-white max-w-3xl text-center animate-fade-in">
                                ...
                                <p className="text-xl md:text-2xl font-light mb-8 text-gray-100 drop-shadow-md">
                                    {slide.subtitle}
                                </p>
                                <div className="flex gap-4 justify-center">
                                    <button
                                        onClick={() => openBooking('General Consultation')}
                                        className="btn-accent text-lg px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all"
                                    >
                                        Book Consultation
                                    </button>
                                    <Link to="/services" className="px-8 py-4 rounded-full border-2 border-white text-white hover:bg-white hover:text-primary-900 transition-all duration-300 font-semibold text-lg shadow-lg">
                                        Explore Services
                                    </Link>
                                </div>
                            </div>
